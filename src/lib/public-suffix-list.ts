/**
 * The Public Suffix List, vendored verbatim from https://publicsuffix.org/list/public_suffix_list.dat
 * with its comments and blank lines stripped. Both the ICANN and the private sections are kept: a
 * page on user-a.github.io and one on user-b.github.io are run by different people, and that is the
 * distinction this list exists to draw.
 *
 * VERSION: 2026-09-18_18-42-54_UTC
 * COMMIT: ff02362b20e273fbcc66405b9b3c21e5dd3e4367
 *
 * This Source Code Form is subject to the terms of the Mozilla Public License, v. 2.0. If a copy of
 * the MPL was not distributed with this file, You can obtain one at https://mozilla.org/MPL/2.0/.
 *
 * Do not hand-edit: replace it wholesale from the URL above. 10325 rules.
 */
